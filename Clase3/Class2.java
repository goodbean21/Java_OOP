public class Class2 {
  ...
  public static void main(String[] args){
    ...
    Car carrito = new Car();
    Engine carritoEngine = carrito.getEngine();
    System.out.println(carritoEngine.getHorsePower());
    System.out.println(carrito.getEngine().getHorsePower());
    System.out.println(carrit.getFl().getSize());


    /* It will receive initialized objects */
    Wheel llantita = new Wheel(22, "Michelin");

    Car carrote = new car(llantita, new Engine(200,4));
    System.out.println(llantita.getSize());
    System.out.println(carrote.getFl().getSize());
